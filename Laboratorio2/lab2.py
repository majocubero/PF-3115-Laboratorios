...
def main(datafile):
    ...
    show_training_plot(w, b, tensor3_AL, tensor3_APM, " training set (X): 80%", str(loss[-1].item()))
    show_training_plot(w, b, tensor1_AL, tensor1_APM, " test set (X): 30 vals", str(loss[-1].item()))
    show_training_plot(w, b, tensor2_AL, tensor2_APM, " test set (X): 20%", str(loss[-1].item()))
    ...
    show_training_plot(w, b, tensor1_AL, tensor1_APM, " test set (Xn): 30 vals", str(loss[-1].item()))
    show_training_plot(w, b, tensor2_AL, tensor2_APM, " test set (Xn): 20%", str(loss[-1].item()))
    
    print("\n---Traninig auto (X)---\n")
    w, b, loss= training_auto(it, w_tensor, b_tensor, alpha_value, tensor3_AL, tensor3_APM)
    show_results_table(w, b, loss)
    show_training_plot(w, b, tensor3_AL, tensor3_APM, " training set (X)- auto: 80%", str(loss[-1].item()))
    show_training_plot(w, b, tensor1_AL, tensor1_APM, " test set (X)- auto: 30 vals", str(loss[-1].item()))
    show_training_plot(w, b, tensor2_AL, tensor2_APM, " test set (X)- auto: 20%", str(loss[-1].item()))
    ...
    show_training_plot_opt(w, b, tensor3_AL, tensor3_APM, " training set opt-Adam (Xn): 80%", str(loss[-1].item()))
    show_training_plot_opt(w, b, tensor1_AL, tensor1_APM, " test set opt-Adam (Xn): 30 vals", str(loss[-1].item()))
    show_training_plot_opt(w, b, tensor2_AL, tensor2_APM, " test set opt-Adam (Xn): 20%", str(loss[-1].item()))
    show_results_table_opt(w, b, loss)
    ...
    show_training_plot_nonlin(a, c, b, tensor1_AL, tensor1_APM, " test set nonlin (Xn): 30 vals", str(loss[-1].item()))
    show_training_plot_nonlin(a, c, b, tensor2_AL, tensor2_APM, " test set nonlin (Xn): 20%", str(loss[-1].item()))
